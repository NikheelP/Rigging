...
import add_new,head_update,spine_update,arm_update,leg_update,tail_update,wing_update,face_update
reload(add_new)
reload(head_update)
reload(spine_update)
reload(arm_update)
...
class AUTO_RIG:
    def __init__(self):
        ...
        self.spine_update_class = spine_update.SPINE_UPDATE()
        self.arm_update_class = arm_update.ARM_UPDATE()
        self.leg_update_class = leg_update.LEG_UPDATE()
        self.tail_update_class = tail_update.TAIL_UPDATE()
        self.wing_update_class = wing_update.WING_UPDATE()
        self.face_update_class = face_update.FACE_UPDATE()
        pass
    ...
    def auto_rig_left_ui(self):
        ...
        # TWICK CONTROLLER
        self.import_preset = QtGui.QPushButton(self.auto_rig_setup_scrollArea_widget_contents)
        self.import_preset.setObjectName("import_preset")
        self.import_preset.setText('Import Preset')
        # self.twick_controller_button.clicked.connect(self.twick_controller_class.twick_controller_create)
        self.verticalLayout_7.addWidget(self.import_preset)
